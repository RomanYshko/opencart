...
<script src="/catalog/view/theme/sellegance/js/js/jquery.min.js"></script>
<script src="/catalog/view/theme/sellegance/js/js/jquery.wallform.js"></script>
<script src="/catalog/view/theme/sellegance/js/js/jqurery.mins.js"></script>
...
<div style=".overflow: hidden;
    ...
    padding: 8px;">
    <p>
        Прикрепить гарантию к заказу
    </p>
    <p>
        - прикрепить несколько файлов<br>
        - доступные форматы  jpeg, png, DOC, PDF, XLSX<br>
        - размер файла не должен превышать 500 KB
    </p>
...
<form  id="imageform" method="post" enctype="multipart/form-data" action=''>
    ...
    <div id='imageloadstatus' style='display:none'><img src="/catalog/view/theme/sellegance/images/loader_upload.gif" alt="Uploading...."/></div>
...
<?php
  if($name_file) { ?>
<p><?php echo "Загрузка завершена"?></p>
<?php foreach ($name_file as $name){ ?>
<span><b><?php echo "Новое имя файла"; ?> <?php echo $name['name_file']; ?></b></span><br>
<?php } ?>
<?php } ?>

<style>
    .imgList{ width: 100px; height: 100px; }
</style>