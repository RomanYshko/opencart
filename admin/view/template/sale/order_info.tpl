...
<div id="content">
    ...
    <div class="box">
        ...
        <div class="content">
            <div class="vtabs" style="display:none;"><a href="#tab-order"><?php echo $tab_order; ?></a><a href="#tab-payment"><?php echo $tab_payment; ?></a>
            ...
            <div id="tab-order">
                <table class="form">
                    <tr>
                        <td><?php echo $text_date_delivery; ?>:</td>
                    ...
                    <tr>
                        <td>Дата получения наложки:</td>
                        <td><?php echo $sum_date; ?></td>
                    </tr>

                    <?php if ($files_name) { ?>
                    <?php foreach ($files_name as $name){ ?>
                    <?php if($name['order_id'] == $order_id){ ?>
                    <tr>
                        <td><?php echo "Гарантийки"?></td>
                        <td>
                            <a href="/image/uploads/<?php echo $name['name_file']?>" download>Скачать</a>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="background-color:#F7F2E0"><?php echo $text_payment_method; ?></td>
                        <td style="background-color:#F7F2E0"><?php echo $payment_method; ?></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="background-color:#81DAF5;"><?php echo $comment; ?></td>
                    </tr>
                    <?php } ?>
                    <tr>
                        <td><?php echo $text_ttn; ?>:</td>
                        <td><?php echo $ttn; ?></td>
                    </tr>
                    <tr>
                        <td>Статус ТТН:</td>
                        <td><?php echo $ttn_status; ?></td>
                    </tr>
                    <tr>
                        <td>Возвратный ТТН:</td>
                        <td><?php echo $back_ttn; ?></td>
                    </tr>
                    <tr>
                        <td>Стоимость доставки товара</td>
                        <td><?php echo $sum_delivery." грн."; ?></td>
                    </tr>
                    <tr>
                        <td>Стоимость доставки денег:</td>
                        <?php

            $sum = (float)$sum_;
            $a = 0.02;
            $b = 20;
            $sum_back_delivery = ($sum * $a) + $b;
            ?>
                        <td><?php echo round($sum_back_delivery)." грн."; ?></td>
                    </tr>
                </table>

                <h2><?php echo $tab_product; ?></h2>
                <table class="list">
                    <thead>
                    <tr>
                        ...
                        <td class="right"><?php echo $column_price_ye; ?></td>
                    ...
                    <tr>
                        ...
                        <td class="right"><?php echo $product['price_ye']; ?></td>
                ...
                <table class="form">
                    <tr>
                        <td><?php echo $text_sum_; ?>:</td>
                        <td><?php echo (float)$sum_; ?></td>
                    </tr>
                    <?php if ($customer) { ?>
                    <tr>
                  ...
                  if($payment_code == cod_5){
                  $sum_all_delivery = 0;
                  }elseif($payment_code == cod_6){
                  $sum_all_delivery = (float)$sum_ -   $sum_back_delivery;
                  }elseif($payment_code == cod_7){
                  $sum_all_delivery = (float)$sum_ - $sum_delivery;
                  }elseif($payment_code == cod_8){
                  $sum_all_delivery = 0;
                  }elseif($payment_code == cod_9){
                  $sum_all_delivery = (float)$sum_ - $sum_delivery;
                  }elseif($payment_code == cod_9){
                  $sum_all_delivery = (float)$sum_ -  $sum_delivery +  $sum_back_delivery;
                  }
          ?>
            ...
            <div id="tab-history">
                <h2><?php echo $tab_order_history; ?></h2>
                <div id="history"></div>
                <table class="form">
                    <tr>
                        <td><?="Name"?></td>
                        <td><input type="text" name="user" value="<?php echo $var; ?>"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="radio" name="notify" value="1" /></td>
                    </tr>
                    <tr>
...
<script type="text/javascript"><!--
    ...
    $('#button-history').live('click', function() {
        $.ajax({
            ...
            type: 'post',
            dataType: 'html',
            data: 'order_status_id=' + encodeURIComponent($('select[name=\'order_status_id\']').val()) + '&notify=' + encodeURIComponent($('input[name=\'notify\']').attr('checked') ? 1 : 0) + '&append=' + encodeURIComponent($('input[name=\'append\']').attr('checked') ? 1 : 0) + '&comment=' + encodeURIComponent($('textarea[name=\'comment\']').val()) + '&users=' + encodeURIComponent ($('input[name=\'user\']').val()),
            beforeSend: function() {
                $('.success, .warning').remove();
