...
class ControllerSaleOrder extends Controller {
    ...
    public function insert() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            ...
            if (isset($this->request->get['filter_shipping_lastname'])) {
                $url .= '&filter_shipping_lastname=' . urlencode(html_entity_decode($this->request->get['filter_shipping_lastname'], ENT_QUOTES, 'UTF-8'));
            }
    ...
    public function update() {
        ...
        $this->data['var'] = $current_username;
    ...
    private function getList() {
        ...
        if (isset($this->request->get['filter_post_date'])) {
            $filter_post_date = $this->request->get['filter_post_date'];
        } else {
            $filter_post_date = null;
        }

        if (isset($this->request->get['filter_ttn_status'])) {
            $filter_ttn_status = $this->request->get['filter_ttn_status'];
        } else {
            $filter_ttn_status = null;
        }
        ...
        $this->data['text_fio_1'] = $this->language->get('text_fio_1');
        $this->data['text_fio_2'] = $this->language->get('text_fio_2');
        $this->data['text_ttn'] = $this->language->get('text_ttn');
        $this->data['text_sum_'] = $this->language->get('text_sum_');
        ...
        $this->data['filter_ttn_status'] = $filter_ttn_status;
        $this->data['filter_shipping_firstname'] = $filter_shipping_firstname;
        $this->data['filter_post_date']=$filter_post_date;
        ...
        $this->data['ttn_statuss'] = $this->model_sale_order->getStatusTtn();
    ...
    public function getForm() {
        ...
        $this->data['text_date_delivery'] = $this->language->get('text_date_delivery');
        $this->data['text_ttn'] = $this->language->get('text_ttn');
        $this->data['text_sum_'] = $this->language->get('text_sum_');
        ...
        $this->data['column_price_ye'] = $this->language->get('column_price_ye');
        $this->data['column_total'] = $this->language->get('column_total');
        ...
        if($this->data['date_delivery'] == "0000-00-00"){
            $this->data['date_delivery'] = '';
        }
        ...
        if (isset($this->request->post['post_date'])) {
            ...
            $this->data['post_date'] = $order_info['post_date'];
        } else {
            $this->data['post_date'] = '';
        }

        if($this->data['post_date'] == "0000-00-00"){
            $this->data['post_date'] = '';
        }

        if (isset($this->request->post['sum_date'])) {
            $this->data['sum_date'] = $this->request->post['sum_date'];
        } elseif (!empty($order_info)) {
            $this->data['sum_date'] = $order_info['sum_date'];
        } else {
            $this->data['sum_date'] = '';
        }

        if($this->data['sum_date'] == "0000-00-00"){
            $this->data['sum_date'] = '';
        }

        if (isset($this->request->post['sum_'])) {
            $this->data['sum_'] = (float)$this->request->post['sum_'];
        } elseif (!empty($order_info)) {
        ...
        if (isset($this->request->post['back_ttn'])) {
            $this->data['back_ttn'] = $this->request->post['back_ttn'];
        } elseif (!empty($order_info)) {
            $this->data['back_ttn'] = $order_info['back_ttn'];
        } else {
            $this->data['back_ttn'] = "";
        }

        if (isset($this->request->post['sum_delivery'])) {
            $this->data['sum_delivery'] = $this->request->post['sum_delivery'];
        } elseif (!empty($order_info)) {
            $this->data['sum_delivery'] = $order_info['sum_delivery'];
        } else {
            $this->data['sum_delivery'] = "";
        }

        if (isset($this->request->post['ttn_status'])) {
            $this->data['ttn_status'] = $this->request->post['ttn_status'];
        } elseif (!empty($order_info)) {
            $this->data['ttn_status'] = $order_info['ttn_status'];
        } else {
            $this->data['ttn_status'] = "";
        }
        ...
        foreach ($order_products as $order_product) {
            /*$query = $this->db->query("SELECT price FROM " . DB_PREFIX . "product WHERE product_id = '" . (int)$order_product['product_id'] . "'");

            if(isset($query->row['price'])){
                $price_ye = $query->row['price'];
            }else{
                $price_ye = " - ";
            }*/
            ...
            $this->data['order_products'][] = array(
                ...
                'price_ye'         => $order_product['price'],
                'total'            => $order_product['total'],
                'tax'              => $order_product['tax'],
                'reward'           => $order_product['reward'],
                'href'             => "/index.php?route=product/product&product_id=" . $order_product['product_id']
        ...
        if(!empty($order_info) || (isset($this->request->get['order_id']) && ($this->request->server['REQUEST_METHOD'] == 'POST'))){
            $this->template = 'sale/order_form_edit.tpl';
        }else{
    ...
    public function info() {
        ...
        if ($order_info) {
            ...
            if($this->data['date_delivery'] == "0000-00-00"){
                ...
                $this->data['date_delivery'] = date($this->language->get('date_format_short'), strtotime($this->data['date_delivery']));
            }
            ...
            if($this->data['post_date'] == "0000-00-00"){
                ...
                $this->data['post_date'] = date($this->language->get('date_format_short'), strtotime($this->data['post_date']));
            }
            ...
            if($this->data['sum_date'] == "0000-00-00"){
                ...
                $this->data['sum_date'] = date($this->language->get('date_format_short'), strtotime($this->data['sum_date']));
            }
            ...
            $this->data['files_name'] = $this->model_sale_fraud->file_name();
    ...
    public function get_sum_(){
        if(isset($this->request->get['order_id'])){
            $query = $this->db->query("SELECT sum_ FROM " . DB_PREFIX . "order WHERE order_id = '" . (int)$this->request->get['order_id'] . "'");
            if(isset($query->row['sum_'])){
                echo (float)$query->row['sum_'];
            }
        }
    }
    ...
    public function get_name(){
        if(isset($this->request->get['order_id'])){
            $query = $this->db->query("SELECT shipping_firstname FROM " . DB_PREFIX . "order WHERE order_id = '" . (int)$this->request->get['order_id'] . "'");
            if(isset($query->row['shipping_firstname'])){
                echo $query->row['shipping_firstname'];
            }
        }
    }
    ...
    public function get_fullname(){
        if(isset($this->request->get['order_id'])){
            $query = $this->db->query("SELECT firstname, lastname FROM " . DB_PREFIX . "order WHERE order_id = '" . (int)$this->request->get['order_id'] . "'");
            if($query->row){
                echo $query->row['firstname'] . " " . $query->row['lastname'];
            }else{
                echo (int)$this->request->get['order_id'];
            }
        }else{
            echo (int)$this->request->get['order_id'];
        }
    ...
    public function get_products_models(){
        if(isset($this->request->get['order_id'])){
            $this->load->model('sale/order');
            $products = $this->model_sale_order->getOrderProducts($this->request->get['order_id']);
            $models = array();
